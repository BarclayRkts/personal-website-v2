...
const Introduction = () => {
    return (
            ...
            <div className="relative md:top-30 flex-shrink-0">
                <div className="w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden flex items-center justify-center bg-surface">
